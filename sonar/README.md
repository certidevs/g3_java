# SonarQube en local (analisis estatico)

Levanta un SonarQube Community en tu máquina para analizar el código en
`http://localhost:9000`: bugs, code smells, vulnerabilidades y duplicación. De paso compila
el proyecto y ejecuta el test que haya (verifica que Spring arranca).
...
.\sonar\analyze.ps1                           # 3) compila, corre el test y sube el análisis
```
Login en http://localhost:9000 → **admin / Adecco.Sonar.2026**
Panel del proyecto: http://localhost:9000/dashboard?id=g3_java
